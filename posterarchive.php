...
#mobile-navbar{
    ...
    <div class="row">
    <div class="column">
        <img src="images/unforgettable-90s-kumarsanu-sadhana.jpeg" alt="Snow" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/umrao-jaan-dallas.jpg" alt="Forest" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/bismil-24.jpg" alt="Mountains" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/jubin-nautiyal.jpeg" alt="Mountains" class="responsive-image">
    </div>
</div>

<div class="row">
    <div class="column">
        <img src="images/atif-aslam-28oct2023.jpg" alt="Snow" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/sidsirram.jpg" alt="Forest" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/sonunigamdallas.jpg" alt="Mountains" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/loltour.jpg" alt="Mountains" class="responsive-image">
    </div>
</div>

<div class="row">
    <div class="column">
        <img src="images/bismil.jpg" alt="Snow" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/KartikAryan_4march2023.jpg" alt="Forest" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/sara.jpg" alt="Mountains" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/nehadallas.jpg" alt="Mountains" class="responsive-image">
    </div>
</div>

<div class="row">
    <div class="column">
        <img src="images/grandtour.jpg" alt="Snow" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/alamgir.jpg" alt="Forest" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/anupamsafar.jpg" alt="Mountains" class="responsive-image">
    </div>
    <div class="column">
        <img src="images/tum-mere-pass-ho.jpg" alt="Mountains" class="responsive-image">
    </div>
</div>

    <div class="row">
        <div class="column">
            <img src="images/event1.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event2.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event3.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event4.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/event5.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event6.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event7.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event8.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/event9.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event10.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event11.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event12.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>
    ...
    <div class="row">
        <div class="column">
            <img src="images/event13.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event14.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event15.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event16.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/event17.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event18.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event19.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event20.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/event21.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event22.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event23.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/event24.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>
