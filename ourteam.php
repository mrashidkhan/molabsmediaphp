    ...
    <nav class="navbar" id="desktop-navbar">
        <div id="desktop-navbar-container">
            ...
            <ul class="mobile-dropdown-list">
                ...
                <li class="csquared-sublink"><a class="menu_link" href="creativewriting.php"> Creative Writing </a>
                </li>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="img-block mb-5">
                        <img src="ourteam/mohammad-abbas.jpg" class="img-fluid  img-thumbnail rounded-circle"
                            alt="image1">
