...
#mobile-navbar{
    ...
    <!-- <div id="video-hero" class="jumbotron hero-height">
        <div id="video-container" class="container hero-container">
            <div id="video-hero-container" class="hp-hero-content-container hp-hero-content-container-alt">
                <img class="hp-hero-logo" src="products/molabsmedia/molabs_logo.png">
                <h1 class="hp-hero-heading">Video Production</h1>
                <p id="video-hero-text" class="hp-hero-text"> We provide quality video production solutions and services. From capturing to final edit, we provide full range of exceptional services to our clients.   </p>
