...
#mobile-navbar{
    ...
    <!-- <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3 mt-3">
            <video width="100%" height="320" controls src="videos/Sara Ali KHAN- Highlight 2022.mp4"> </video>
            </div>


            <div class="col-sm-3 mt-3">
                <span >
                <video width="100%" height="320" controls src="videos/Dallas- Rewind Mix-1 2022.mp4"> </video>
                </span>
            </div>
            ...
            <div class="col-sm-3 mt-3">
                <span>
                <video width="100%" height="320" controls src="videos/FilmForth Untitled.mp4"> </video>   
                </span>
            </div>

            <div class="col-sm-3 mt-5" >
                <span>
                <video width="100%" height="320" controls src="videos/ARIJIT SINGH DALLAS Highlights 2022.mp4"> </video>    
                </span>
            </div>
    ...
    <!-- <div class="row">
        <div class="column">
            <video width="100%" height="320px" controls src="videos/Dallas Rewind Mix-3 2022.mp4"> </video>
        </div>
        <div class="column">
            <video width="100%" height="320" controls src="videos/Indian Idol Promo 1 2022.mp4"> </video>
        </div>
        <div class="column">
            <video width="100%" height="320" controls src="videos/Neha Kakar Video 2022.mp4"> </video>
        </div>
        <div class="column">
            <video width="100%" height="320" controls src="videos/Dallas Rewind Mix-2 2022.mp4"> </video>
        </div>
    </div>
