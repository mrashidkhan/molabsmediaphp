    ...
    <nav class="navbar" id="desktop-navbar">
        <div id="desktop-navbar-container">
            ...
            <ul class="mobile-dropdown-list">
                ...
                <li class="csquared-sublink"><a class="menu_link" href="upcomingevents.php"> Upcoming Events
                    </a>
                </li>
...
#mobile-navbar{
    ...
    <div id="contactus-hero" class="jumbotron hero-height">
        <div id="content-container" class="container hero-container">
            <div id="content-hero-container" class="hp-hero-content-container hp-hero-content-container-alt">
                ...
                <!-- <p id="content-hero-text" class="hp-hero-text"> Our team of professional have expertise in different IT
                    services. We work on different IT Services that is effective and persuasive. </p>
                <button onclick="getButtonId(this)" name="Content Hero Button" id="content-hero-button"
                    class="outlined-white-button" type="button" data-toggle="modal" data-target="#buttonModal">Contact
                    Us</button> -->
            </div>
        </div>
    ...
    <div class="row">
        <div class="column">
            <img src="images/pics/pic1.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic2.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic3.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic4.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic5.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic6.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic7.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic8.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic9.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic10.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic11.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic12.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>
    ...
    <div class="row">
        <div class="column">
            <img src="images/pics/pic13.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic14.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic15.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic16.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic17.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic18.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic19.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic20.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic21.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic22.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic23.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic24.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic25.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic26.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic27.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic28.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic29.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic30.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic31.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic32.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic33.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic34.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic35.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic36.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>
    ...
    <div class="row">
        <div class="column">
            <img src="images/pics/pic37.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic38.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic39.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic40.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic41.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic42.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic43.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic44.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>

    <div class="row">
        <div class="column">
            <img src="images/pics/pic45.jpg" alt="Snow" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic46.jpg" alt="Forest" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic47.jpg" alt="Mountains" style="width:100%">
        </div>
        <div class="column">
            <img src="images/pics/pic48.jpg" alt="Mountains" style="width:100%">
        </div>
    </div>
