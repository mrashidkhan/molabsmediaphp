    ...
    <nav class="navbar" id="desktop-navbar">
        <div id="desktop-navbar-container">
                        ...
                        <ul class="submenu dropdown-menu dropdown-menu-dark">
                            ...
                            <li><a class="dropdown-item" href="pastevents.php">Past Events &raquo; </a>
                                <ul class="submenu dropdown-menu dropdown-menu-dark">
                                    ...
                                    <li><a class="dropdown-item" href="postersarchive.php">Poster Archive</a></li>
                                </ul>
                            </li>
            ...
            <ul class="mobile-dropdown-list">
                ...
                <li class="csquared-sublink"><a class="menu_link" href="postersarchive.php"> Poster Archive
                    </a>
                </li>
...
#mobile-navbar{
    ...
    <!--  <div id="creative-hero" class="jumbotron hero-height">
        <div id="creative-container" class="container hero-container">
            <div id="creative-hero-container" class="hp-hero-content-container hp-hero-content-container-alt">
                <img class="hp-hero-logo" src="products/molabsmedia/molabs_logo.png">
                <h1 class="hp-hero-heading ">Creative Writing</h1>
                <p id="creative-hero-text" class="hp-hero-text "> We provide creative writing services. We provide personalized and audience engaging content which is unique to your businesses and brands.  </p>
                ...
                <div class="inside-container-content-container-right">
                    <div id="content-three-content">
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body copy-one" style="background-color: #EDA0A8;">
                            We know in today’s technology world, employees with professional and technical skills are always in high demand. Therefore, we work very diligently to provide you with the right candidates that fits your business needs.
                            </div>
                        </div> -->
            ...
            <div id="likeDrivesCol" class="col-md">
                <div class="inside-container-content-container-right">
                    <div id="content-three-content">
                        ...
                        <h1 class="body-headings">Creative Writing</h1>
                        <p class="copy-one">We provide creative writing services. We provide personalized and audience engaging content which is unique to your businesses and brands.</p>
                        <button onclick="getButtonId(this)" name="Content Like Drives Button" id="content-three-button"
                            class="outlined-black-button" type="button" data-toggle="modal"
                            data-target="#buttonModal">book demo</button>
                    </div>
